<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
 <%@ page import="com.book.model.Book,com.book.DAO.BookDAO,com.book.DAOimpl.BookDAOimpl,java.util.List" %> 
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <section class="genres">
            ...
            <div class="genre-grid">
				...
				<%
				String name="";
				List<Book> books=(List<Book>)request.getAttribute("b");
				...
				<div class="genre-card">
						    <img src="<%=book.getImagepath() %>" alt="Book Cover" class="book-cover">
						    <div class="card-content">
						       
						        <div class="book-author"><%=book.getBookname() %></div>
